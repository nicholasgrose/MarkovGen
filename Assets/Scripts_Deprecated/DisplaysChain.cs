...
using Assets.Scripts_Deprecated.ProceduralGeneration.MarkovMapGenerator.PureMarkov;
using UnityEngine;
using PureMarkovGenAlgorithm = Assets.Scripts_Deprecated.ProceduralGeneration.MarkovMapGenerator.PureMarkov.PureMarkovGenAlgorithm;
